<template>
  <f7-page>
    <f7-navbar title="Speed Dial" back-link="Back" sliding>
      <f7-nav-right>
    ...
    <f7-fab-speed-dial>
      <f7-fab-actions>
        <f7-fab-action>
          <f7-icon f7="email" size="20px"></f7-icon>
        </f7-fab-action>
        <f7-fab-action>
          <f7-icon f7="today" size="20px"></f7-icon>
        </f7-fab-action>
        <f7-fab-action>
          <f7-icon f7="download" size="20px"></f7-icon>
        </f7-fab-action>
      </f7-fab-actions>
      <f7-fab>
