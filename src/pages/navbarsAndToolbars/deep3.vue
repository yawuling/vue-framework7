<template>
  <f7-page>
    <f7-navbar>
      <f7-nav-left sliding>
        <f7-link back>Deep 2</f7-link>
      </f7-nav-left>
      <f7-nav-center sliding>Deep 3</f7-nav-center>
      <f7-nav-right sliding>
        <f7-link href="/" @click="clearCache">Framework7</f7-link>
      </f7-nav-right>
    </f7-navbar>
    <f7-block>
      <p>
        <f7-button href="/" @click="clearCache">Go to home page</f7-button>
      </p>
      <p>
